...
- Develop the MVPs on **Google Big Query** to ensure robust data pipelines, scalability, and faster computing performance.  
- Creating and maintaining **technical documentation** to ensure clarity, reproducibility, and future scalability of the process.  


---

## My projects up until now:
...
- **FRF Football Analytics**    *On going*
...
- **ZGB Spotify Popularity — Kaggle Analysis**    *On going*
...
- **LSS Shop Prototype**    *On going*
  
  Collaborative **full-stack web app** developed after the **2025 Lenovo Summer School**, simulating real-world teamwork across **Frontend, Backend, and DevOps**.  
  *Angular, Node.js, Express, MongoDB, Agile Collaboration*
   *Node&Express JS + Others*

**University Labs**

**Nextlab Labs**

  Repository for hosting homeworks from Web Technology Course.
